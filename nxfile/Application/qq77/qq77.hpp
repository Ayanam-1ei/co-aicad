...
#ifndef QQ77_H_INCLUDED
#define QQ77_H_INCLUDED
...
public:
    ...
    // of these prototypes is provided in the qq77.cpp file. 
...
private:
    ...
    int m_selectedResult;  // 0=移动, 1=复制
    int performTransform(NXOpen::Features::MoveObjectBuilder::MoveObjectResultOptions mode);
    
};
#endif //QQ77_H_INCLUDED
